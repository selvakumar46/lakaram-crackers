...
import com.crackers.store.repository.ProductRepository;
...
public class ProductService {
    ...
    private void seedInitialProductsIfEmpty() {
        if (productRepository.count() > 0) {
            return; // Database already contains persisted products
        }
    ...
    public List<Product> getProductsByCategory(String categoryId) {
        return productRepository.findByCategoryIgnoreCase(categoryId);
    }
